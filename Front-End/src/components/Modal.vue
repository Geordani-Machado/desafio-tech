              ...
              <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    <DialogTitle as="h3" class="text-3xl leading-6 font-medium text-gray-900 mb-5">👋 Olá @userName </DialogTitle>
                    <div class="mt-2">
                      <p class="text-1xl text-gray-500">Are you sure you want to deactivate your account? 
